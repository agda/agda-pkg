...
def installFromGit():
  ...
  with TemporaryDirectory() as tmpdir:
    ...
    try:
      ...
      logger.error(e)
      logger.error("There was an error when installing the library. May you want to run `apkg clean && apkg init`?")
      return None
...
@click.option('--name'
             , type=str
             , help='Help to disambiguate when many agda library files exist\
